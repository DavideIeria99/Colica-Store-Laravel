<x-layout docTitle="home"
    ...
    {{-- @dd($article_to_check->images()->get()) --}}
    <div class="container">
        <div class="row ">
            <div class="col-12">
    ...
    @if ($article_to_check)
        <div class="container">
                ...
                <div class="col-12 col-md-6 justify-content-center">
                    <div class="row mysection p-3 me-1">
                        ...
                        <div class="col-12 mysectionx p-3">
                            <h3 class="text-dark"><span class="titleText">{{ __('messages.Nome') }}:
                                    {{ $article_to_check->name }}</span></h3>
                        </div>
                        <div class="col-12 mysectionx p-3">
                            <h3 class="text-dark">{{ __('messages.Categoria') }}: {{ $article_to_check->genre->genre }}
                            </h3>
                        </div>
                        <div class="col-12 mysectionx p-3">
                            ...
                            {{-- <div class="col-12">
                                <div class="row justify-content-evenly">
                                    <div class="col-12 col-md-5 mysectionx p-3">
                                        ...
                                        <li><span class="me-2 wMe ">{{ __('messages.Adulti') }}:</span><span
                                                class="{{ $article_to_check->images()->first()->adult }}"></span></li>
                                        <li><span class="me-2 wMe ">{{ __('messages.Satira') }}:</span><span
                                                class="{{ $article_to_check->images()->first()->spoof }}"></span></li>
                                        <li><span class="me-2 wMe ">{{ __('messages.Medicina') }}:</span><span
                                                class="{{ $article_to_check->images()->first()->medical }}"></span>
                                        </li>
                                        <li><span class="me-2 wMe ">{{ __('messages.Violenza') }}:</span><span
                                                class="{{ $article_to_check->images()->first()->violence }}"></span>
                                        </li>
                                        <li><span class="me-2 wMe ">{{ __('messages.Razzismo') }}:</span><span
                                                class="{{ $article_to_check->images()->first()->racy }}"></span></li>
                                    </div>
                                    <div class="col-12 col-md-5 mysectionx p-3">
                                        <h3 class="textdarkw text-dark">{{ __('messages.ettichette') }}</h3>
                                        @foreach ($article_to_check->images()->first() as $label)
                                            <li class="">{{ $label }}</li>
                                        @endforeach
                                    </div>
                                </div>
                    ...
                    <div class="swiper-wrapper">
                        @foreach ($article_to_check->images()->get() as $item)
                            <div class="swiper-slide">
                                <div class="card">
                                    <img src="{{ $item->getUrl(400, 300) }}" class="d-block" alt="" />
                                    <div class="card-body bgMain">
                                        <div class="d-flex align-items-center">
                                            <div class="pe-3">
                                                ...
                                                <ul>
                                                    <li class="colorAcc">
                                                        <span class="me-2 wMe colorAcc">{{ __('messages.Adulti') }}:
                                                        </span>
                                                        <span
                                                            class="{{ $article_to_check->images()->first()->adult }}">
                                                        </span>
                                                    </li>
                                                    <li class="colorAcc"><span
                                                            class="me-2 wMe colorAcc">{{ __('messages.Satira') }}:</span><span
                                                            class="{{ $article_to_check->images()->first()->spoof }}"></span>
                                                    </li>
                                                    <li class="colorAcc"><span
                                                            class="me-2 wMe colorAcc">{{ __('messages.Medicina') }}:</span><span
                                                            class="{{ $article_to_check->images()->first()->medical }}"></span>
                                                    </li>
                                                    <li class="colorAcc"><span
                                                            class="me-2 wMe colorAcc">{{ __('messages.Violenza') }}:</span><span
                                                            class="{{ $article_to_check->images()->first()->violence }}"></span>
                                                    </li>
                                                    <li class="colorAcc"><span
                                                            class="me-2 wMe colorAcc">{{ __('messages.Razzismo') }}:</span><span
                                                            class="{{ $article_to_check->images()->first()->racy }}"></span>
                                                    </li>
                                                </ul>
                                            </div>
            ...
            @elseif(count($article_to_check->images()->get()) == 0)
                <div class="coldetdxd ">
                    <div class="card">
                        <img src="{{ !$article_to_check->images()->get()->isEmpty() ? $article_to_check->images()->first()->getUrl(400, 300) : '/media/default.jpg' }}"
                            class="d-block" />
                    </div>
                </div>
            </div>
